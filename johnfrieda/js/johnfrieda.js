...
$('.timer').css('display','none')
  ...
  var url = 'https:api.bazaarvoice.com/data/products.json?apiversion=5.4&passkey=ca21LxI9Ej9wmV05OgbNJsR1fIWUWr27R7al96QzavQa0&Locale=&filter=IsActive:true&Limit=100'
  var lastIndex
  var productId = []
  var productId100 = []
  var count = 1
  ...
  function getReviews(productIds) {
    ...
    var urlForReviews = 'https:api.bazaarvoice.com/data/reviews.json?apiversion=5.4&passkey=ca21LxI9Ej9wmV05OgbNJsR1fIWUWr27R7al96QzavQa0&Stats=Reviews&Limit=100&filter=SubmissionTime:gt:' + secondsSinceEpoch_30 + '&filter=SubmissionTime:lt:' + secondsSinceEpoch + '&filter=ProductId:'
  ...
  function productDisplay(jsonobject_productReviews) {
    ...
    if (jsonobject_productReviews.Reviews[count1].UserLocation != null) {
      var imgUrl = '<div class="container"><div class="logos"><div class="live-feed"><img src="JF_MB_RatingsAndReviews_HuddleArea_R3_Wireframe_LiveFeedAsset.png"></div><div class="logo-image"><img src="JF_MB_RatingsAndReviews_HuddleArea_R3_Wireframe_Logo.png"></div></div><h2 class="product-name">' + jsonobject_productReviews.Reviews[count1].ProductName + '</h2><div class="product-info"><div class="product-image"><img src=' + jsonobject_productReviews.Reviews[count1].ImageUrl + ' alt="no image found"></div><div class="review-info"><h2 class="review-title">' + '&ldquo;' + jsonobject_productReviews.Reviews[count1].ReviewTitle + '&rdquo;' + '</h2><p class="review-text">' + '&ldquo;' + jsonobject_productReviews.Reviews[count1].ReviewText + '&rdquo;' + '</p><p class="reviewer">' + '-' + jsonobject_productReviews.Reviews[count1].UserNickname + ', ' + jsonobject_productReviews.Reviews[count1].UserLocation + '</p><div class="rating"><img src="./Ratings/' + jsonobject_productReviews.Reviews[count1].Rating + '.png"></div></div></div></div></div></div>';
    } else if (jsonobject_productReviews.Reviews[count1].UserLocation == null) {
      var imgUrl = '<div class="container"><div class="logos"><div class="live-feed"><img src="JF_MB_RatingsAndReviews_HuddleArea_R3_Wireframe_LiveFeedAsset.png"></div><div class="logo-image"><img src="JF_MB_RatingsAndReviews_HuddleArea_R3_Wireframe_Logo.png"></div></div><h2 class="product-name">' + jsonobject_productReviews.Reviews[count1].ProductName + '</h2><div class="product-info"><div class="product-image"><img src=' + jsonobject_productReviews.Reviews[count1].ImageUrl + ' alt="no image found"></div><div class="review-info"><h2 class="review-title">' + '&ldquo;' + jsonobject_productReviews.Reviews[count1].ReviewTitle + '&rdquo;' + '</h2><p class="review-text">' + '&ldquo;' + jsonobject_productReviews.Reviews[count1].ReviewText + '&rdquo;' + '</p><p class="reviewer">' + '-' + jsonobject_productReviews.Reviews[count1].UserNickname + '</p><div class="rating"><img src="./Ratings/' + jsonobject_productReviews.Reviews[count1].Rating + '.png"></div></div></div></div></div></div>';
    }
    if (count1 % 2 == 0)
