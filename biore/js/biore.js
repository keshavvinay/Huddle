...
$(document).ready(function () {
	...
	console.log('page refreshed at ' + time)
var totalTime=55
...
setTimeout(function () {
$('.timer').text('100%')
setTimeout(function(){$('.loading').css('display','none')
$('.timer').css('display','none'),3000})
	...
	var conversationApis = ['caARuaQuTxzz8ybfi8eiWDifStxWAfTYHSGmUMGqpcfzI', 'caypHhRjDOLEzZnDyG2uIpyKxFLjvdKm89r8pOT3vLFTc']
	...
	function productDisplay(jsonobject_productReviews) {
		...
		if (jsonobject_productReviews.Reviews[jsonobject_productReviews.Reviews.length - 1].UserLocation != null) {
			var imgUrl = '<div class="container"><div class="logos"><div class="logo-image"><img src="BIO_RatingsAndReviews_HuddleArea_R2_Style Guide_72dpi_Logo.png"></div><div class="live-feed"><img src="BIO_RatingsAndReviews_HuddleArea_R2_Style Guide_72dpi_Live Feed.png"></div></div><div class="product-info"><div class="product-image"><img src=' + jsonobject_productReviews.Reviews[jsonobject_productReviews.Reviews.length - 1].ImageUrl + ' alt="no image found"></div><div class="review-info"><h2 class="review-title">' + jsonobject_productReviews.Reviews[jsonobject_productReviews.Reviews.length - 1].ReviewTitle + '</h2><p class="review-text">' + jsonobject_productReviews.Reviews[jsonobject_productReviews.Reviews.length - 1].ReviewText + '</p><p class="reviewer">' + '-' + jsonobject_productReviews.Reviews[jsonobject_productReviews.Reviews.length - 1].UserNickname + ', ' + jsonobject_productReviews.Reviews[jsonobject_productReviews.Reviews.length - 1].UserLocation + '</p><div class="rating"><img src="./Ratings/' + jsonobject_productReviews.Reviews[jsonobject_productReviews.Reviews.length - 1].Rating + '.png"></div></div></div></div></div></div>';
		} else if (jsonobject_productReviews.Reviews[jsonobject_productReviews.Reviews.length - 1].UserLocation == null) {
			var imgUrl = '<div class="container"><div class="logos"><div class="logo-image"><img src="BIO_RatingsAndReviews_HuddleArea_R2_Style Guide_72dpi_Logo.png"></div><div class="live-feed"><img src="BIO_RatingsAndReviews_HuddleArea_R2_Style Guide_72dpi_Live Feed.png"></div></div><div class="product-info"><div class="product-image"><img src=' + jsonobject_productReviews.Reviews[jsonobject_productReviews.Reviews.length - 1].ImageUrl + ' alt="no image found"></div><div class="review-info"><h2 class="review-title">' + jsonobject_productReviews.Reviews[jsonobject_productReviews.Reviews.length - 1].ReviewTitle + '</h2><p class="review-text">' + jsonobject_productReviews.Reviews[jsonobject_productReviews.Reviews.length - 1].ReviewText + '</p><p class="reviewer">' + '-' + jsonobject_productReviews.Reviews[jsonobject_productReviews.Reviews.length - 1].UserNickname + '</p><div class="rating"><img src="./Ratings/' + jsonobject_productReviews.Reviews[jsonobject_productReviews.Reviews.length - 1].Rating + '.png"></div></div></div></div></div></div>';
		}
		if (count1 % 2 == 0)
